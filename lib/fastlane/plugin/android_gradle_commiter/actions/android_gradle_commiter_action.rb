...
require_relative '../helper/android_gradle_commiter_helper'

module Fastlane
  module Actions
    class AndroidGradleCommiterAction < Action
      def self.run(params)
          require 'xcodeproj'
          require 'pathname'
          require 'set'
        ...
        if build_file_folder != nil
            UI.message("The android_gradle_commiter plugin will use gradle file at (#{build_file_folder})!")
            ...
            UI.message("The android_gradle_commiter plugin is looking inside your project folder (#{app_folder_name})!")
